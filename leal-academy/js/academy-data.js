const academyCourses = [
    ...
    {
        "id": "chart-bagagem-iata",
        "title": "Interpretação do Chart de Bagagem IATA",
        "eyebrow": "Identificação visual",
        "category": "bagagem",
        "level": "Básico",
        "duration": "1h 20min",
        "color": "#0284c7",
        "summary": "Leitura prática do Baggage Identification Chart: cores, tipo de volume, elementos descritivos, artigos diversos e aplicação correta em AHL, OHD e DPR.",
        "modules": [
            {
        ...
        "labs": [
            {
                "label": "Laboratório AHL Web",
                "href": "ahl.html"
            },
            {
                "label": "Laboratório OHD Web",
                "href": "ohd.html"
            },
            {
                "label": "Máscara AHL WorldTracer",
                "href": "worldtracer/ahl.html"
            },
            {
                "label": "Máscara OHD WorldTracer",
                "href": "worldtracer/ohd.html"
            }
        ],
        "quiz": [
            {
                ...
                "options": [
                    "Padronizar a descrição visual da bagagem para facilitar identificação e match",
                    "Substituir a etiqueta da bagagem",
                    "Definir indenização ao passageiro",
                    "Informar peso permitido no voo"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "A cor predominante da bagagem",
                    "A cor preferida do passageiro",
                    "A cor da etiqueta",
                    "A cor do uniforme do agente"
                ],
                "correct": 0
            },
            {
            ...
            },
            {
                ...
                "options": [
                    "O tipo visual do volume mais parecido com a bagagem",
                    "O preço da bagagem",
                    "A companhia que fabricou a mala",
            ...
            },
            {
                ...
                "options": [
                    "Diferenciar volumes parecidos por características visíveis",
                    "Apagar a necessidade da cor",
                    "Substituir o número da etiqueta",
                    "Criar categoria de conteúdo"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Rodinhas, alça, bolso externo, cinta ou zíper aparente",
                    "Nome do agente",
                    "Horário do almoço",
                    "Número do balcão"
                ],
            ...
            },
            {
                ...
                "options": [
                    "Itens que não se encaixam como mala tradicional",
                    "Apenas malas pretas",
                    "Somente bagagem extraviada internacional",
                    "Excluir o registro do WorldTracer"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Objetiva, padronizada e útil para outro aeroporto reconhecer o volume",
                    "Longa, subjetiva e sem códigos",
                    "Baseada apenas no conteúdo",
                    "Feita em português sempre que possível"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Escolher o formato visual mais próximo e complementar com elementos descritivos",
                    "Escolher qualquer código",
                    "Deixar o campo em branco",
                    "Usar sempre o primeiro tipo da lista"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Melhor qualidade de match entre bagagem extraviada e bagagem sobrante",
                    "Aumentar o peso permitido",
                    "Emitir cartão de embarque",
                    "Alterar a rota do passageiro"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Descrever de forma genérica, como mala comum, sem cor/tipo/característica",
                    "Comparar a bagagem com o chart",
                    "Usar característica visível",
                    "Confirmar a cor predominante"
                ],
                "correct": 0
            },
            {
                ...
                "options": [
                    "Cor predominante + tipo visual + elementos descritivos relevantes",
                    "Nome do passageiro + preço + marca",
                    "Destino + telefone + assento",
                    "Peso + horário + balcão"
                ],
                "correct": 0
            }
