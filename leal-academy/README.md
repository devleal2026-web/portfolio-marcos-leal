...
Essa checagem compara os SQLs de cursos com o conteudo completo aprovado e com o baseline minimo em `quality/course-content-baseline.json`. O baseline atual protege 41 cursos. Se um curso perder modulos, ficar com conteudo muito curto ou tiver reducao relevante de material, o comando falha e aponta o curso afetado.
