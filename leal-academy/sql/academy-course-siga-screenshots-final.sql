-- Updates only the SIGA screenshot paths to the final image files.
        ...
        case lesson.module ->> 'title'
            when 'Conceito e finalidade' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-conceito-finalidade-final.jpg',
            ...
            when 'Acesso seguro' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-acesso-seguro-final.jpg',
            ...
            when 'Dashboard operacional' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-dashboard-operacional-final.jpg',
            ...
            when 'Controle de voos' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-controle-voos-final.jpg',
            ...
            when 'Atualizações operacionais' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-atualizacoes-operacionais-final.jpg',
            ...
            when 'Avisos, alertas e incidentes' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-avisos-alertas-incidentes-final.jpg',
            ...
            when 'Colaboração e feedback' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-colaboracao-feedback-final.jpg',
            ...
            when 'Boas práticas de uso' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-boas-praticas-final.jpg',
