...
values (
    ...
    $modules_libras$[
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-01-acessibilidade.svg?v=3",
        "title": "Acessibilidade comunicacional",
        "caption": "Avatar genérico de agente e soletração OLA para abertura acessível do atendimento."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-02-cultura-surda.svg?v=3",
        "title": "Cultura surda e LIBRAS",
        "caption": "Soletração LIBRAS e condutas visuais para respeitar a preferência comunicacional."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-03-parametros.svg?v=3",
        "title": "Parâmetros dos sinais",
        "caption": "Imagem didática dos parâmetros dos sinais: mão, ponto, movimento, orientação e expressão."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-04-alfabeto-numeros.svg?v=3",
        "title": "Alfabeto e números",
        "caption": "Alfabeto manual de LIBRAS em quadro autoral para datilologia de dados aeroportuários."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-05-primeiro-contato.svg?v=3",
        "title": "Primeiro contato",
        "caption": "Simulação visual da soletração AJUDA no primeiro contato com o passageiro."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-06-checkin.svg?v=3",
        "title": "Check-in e bagagem",
        "caption": "Simulação visual da palavra VOO e dos campos críticos do check-in."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-07-embarque.svg?v=3",
        "title": "Embarque e conexão",
        "caption": "Simulação de ATRASO, PORTÃO e B12 com apoio visual de datilologia."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-08-bagagem.svg?v=3",
        "title": "Bagagem no desembarque",
        "caption": "Simulação de MALA e siglas AHL, DPR e OHD para entrevista de bagagem."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-09-pnae.svg?v=3",
        "title": "Atendimento PNAE",
        "caption": "Avatar genérico e soletração AJUDA para atendimento PNAE com consentimento."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-10-seguranca.svg?v=3",
        "title": "Segurança e emergência",
        "caption": "Avatar genérico com orientação crítica: PARE, ESPERE e SIGA."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-11-dialogos.svg?v=3",
        "title": "Diálogos práticos",
        "caption": "Perguntas essenciais em atendimento aeroportuário com apoio visual de LIBRAS."
      }
    ],
  ...
  },
  {
    ...
    "screenshots": [
      {
        "src": "../assets/academy-screenshots/libras-aeroportos/libras-12-simulacoes.svg?v=3",
        "title": "Simulações avaliativas",
        "caption": "Checklist visual de simulação com confirmação final OK."
      }
    ],
...
- LIBRAS01 - Apostila de LIBRAS Básico: usada como referência para alfabeto de LIBRAS, cultura surda, parâmetros dos sinais, numerais, tipos de frases, perguntas, horários, negação e estrutura de diálogos.

Como as referências foram utilizadas
O conteúdo foi reorganizado para o contexto aeroportuário, com situações de check-in, embarque, conexão, PNAE, AHL, DPR, OHD, orientação crítica e atendimento em irregularidades de bagagem. As imagens do curso são autorais, inspiradas nas referências visuais dos materiais, com avatar genérico de agente aeroportuário, alfabeto manual e simulações visuais relacionadas a cada trilha.
