    ...
    "screenshots": [
      {
        ...
        "caption": "Apoio visual sobre língua, identidade, preferência comunicacional e autonomia."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Apoio para nomes, códigos, horários, voos e etiquetas de bagagem."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Fluxo visual de acolhimento, identificação da necessidade e confirmação."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Cenário autoral de balcão, documento, etiqueta e despacho de volume."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Apoio visual para comunicação de portão, atraso, chamada e conexão."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Cenário de entrevista acessível para extravio, dano e bagagem sobrante."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Imagem sobre consentimento, rota assistida, autonomia e comunicação direta."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Apoio para mensagens visuais de pare, espere, siga e peça ajuda."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Simulações com perguntas, respostas, confirmação e resolução."
      }
    ],
    ...
    "screenshots": [
      {
        ...
        "caption": "Checklist autoral para roleplay, avaliação e feedback de atendimento."
      }
    ],
