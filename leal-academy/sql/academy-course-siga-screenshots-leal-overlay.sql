-- Updates only the SIGA screenshot paths to the Leal Academy overlay image files.
        ...
        case lesson.module ->> 'title'
            when 'Conceito e finalidade' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-conceito-finalidade-leal.jpg',
            ...
            when 'Acesso seguro' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-acesso-seguro-leal.jpg',
            ...
            when 'Dashboard operacional' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-dashboard-operacional-leal.jpg',
            ...
            when 'Controle de voos' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-controle-voos-leal.jpg',
            ...
            when 'Atualizações operacionais' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-atualizacoes-operacionais-leal.jpg',
            ...
            when 'Avisos, alertas e incidentes' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-avisos-alertas-incidentes-leal.jpg',
            ...
            when 'Colaboração e feedback' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-colaboracao-feedback-leal.jpg',
            ...
            when 'Boas práticas de uso' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-boas-praticas-leal.jpg',
