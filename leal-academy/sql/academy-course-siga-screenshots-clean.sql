-- Updates only the SIGA screenshot paths to clean cropped image files.
        ...
        case lesson.module ->> 'title'
            when 'Conceito e finalidade' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-conceito-finalidade-clean.jpg',
            ...
            when 'Acesso seguro' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-acesso-seguro-clean.jpg',
            ...
            when 'Dashboard operacional' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-dashboard-operacional-clean.jpg',
            ...
            when 'Controle de voos' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-controle-voos-clean.jpg',
            ...
            when 'Atualizações operacionais' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-atualizacoes-operacionais-clean.jpg',
            ...
            when 'Avisos, alertas e incidentes' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-avisos-alertas-incidentes-clean.jpg',
            ...
            when 'Colaboração e feedback' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-colaboracao-feedback-clean.jpg',
            ...
            when 'Boas práticas de uso' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-boas-praticas-clean.jpg',
