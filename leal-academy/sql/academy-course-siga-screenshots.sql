-- Adds support screenshots to the SIGA course without changing existing lesson text.
-- This update preserves every current module field and only sets the screenshots array
-- for the matching SIGA lesson titles.
        ...
        case lesson.module ->> 'title'
            when 'Conceito e finalidade' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-conceito-finalidade.jpg',
            ...
            when 'Acesso seguro' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-acesso-seguro.jpg',
            ...
            when 'Dashboard operacional' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-dashboard-operacional.jpg',
            ...
            when 'Controle de voos' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-controle-voos.jpg',
            ...
            when 'Atualizações operacionais' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-atualizacoes-operacionais.jpg',
            ...
            when 'Avisos, alertas e incidentes' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-avisos-alertas-incidentes.jpg',
            ...
            when 'Colaboração e feedback' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-colaboracao-feedback.jpg',
            ...
            when 'Boas práticas de uso' then
                lesson.module || jsonb_build_object(
                    ...
                    jsonb_build_array(
                        jsonb_build_object(
                            'src', '../assets/academy-screenshots/siga/siga-boas-praticas.jpg',
